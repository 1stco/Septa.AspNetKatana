...
namespace Microsoft.Owin.Security.OpenIdConnect
{
    ...
    public class SeptaOpenIdConnectAuthenticationMiddleware : AuthenticationMiddleware<OpenIdConnectAuthenticationOptions>
    {
        ...
        private static readonly ConcurrentDictionary<string, OpenIdConnectAuthenticationOptions> _optionsDic = new ConcurrentDictionary<string, OpenIdConnectAuthenticationOptions>();
        ...
        public SeptaOpenIdConnectAuthenticationMiddleware(OwinMiddleware next, IAppBuilder app, Func<string> optionsKeyFunc, Func<string, OpenIdConnectAuthenticationOptions> optionsFunc)
            : base(next, GetOption(optionsKeyFunc(), optionsFunc))
        {
        ...
        private static OpenIdConnectAuthenticationOptions GetOption(string key, Func<string, OpenIdConnectAuthenticationOptions> optionsFunc)
        {
           return _optionsDic.GetOrAdd(key, k => optionsFunc(key));
        }
